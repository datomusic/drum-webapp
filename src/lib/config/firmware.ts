 ...
 */
export const FALLBACK_FIRMWARE_VERSION = "v0.9.5";

/**
 * The fallback URL to download the firmware (.uf2) file.
 * Used when GitHub API is unavailable.
 */
export const FALLBACK_FIRMWARE_DOWNLOAD_URL = "https://github.com/datomusic/drum-firmware/releases/download/v0.9.5/drum-0.9.5.uf2";
