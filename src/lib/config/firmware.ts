 ...
 */
export const FALLBACK_FIRMWARE_VERSION = "v1.0.0-rc.1";

/**
 * The fallback URL to download the firmware (.uf2) file.
 * Used when GitHub API is unavailable.
 */
export const FALLBACK_FIRMWARE_DOWNLOAD_URL = "https://github.com/datomusic/drum-firmware/releases/download/v1.0.0-rc.1/drum-1.0.0-rc.1.uf2";
